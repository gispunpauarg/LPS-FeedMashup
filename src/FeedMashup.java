...
import javax.swing.JSeparator; import javax.swing.JTextField; 
...
import java.awt.*; 
public 
class  FeedMashup  extends JFrame {
	...
	/*							 
		...
		FMtruncate=true;
		lbTruncate = new JLabel("Truncate   :");
		panel1.add(lbTruncate);
		panel1.add(jtfTruncate);
	
		FMsort=true;
		lbSort = new JLabel("Sort      :");
		panel1.add(lbSort);
		panel1.add(check1);
		panel1.add(check2);
		panel1.add(check3);
